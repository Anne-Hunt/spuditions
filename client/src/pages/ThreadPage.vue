	...
	<section class="row me-0">
		...
		<div class="col-12 col-lg-10 mt-4">
			...
			<div class="row me-0">
				...
				<div class="col-12">
					<div class="card p-2 mx-4 mt-3 bg-teal">
						<form @submit.prevent="createPost()">
							<div class="mt-3 mx-3">
								<textarea v-model="postData.body" placeholder="Share your thoughts..." type="text"
									class="form-control" id="post-body" required minLength="5" maxLength="300"
									rows="5"></textarea>
							</div>
				...
				<div class="my-4 ps-4 ps-lg-0 px-md-3">
