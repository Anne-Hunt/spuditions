...
export const ThreadSchema = new Schema({
    // "Ashton to Tetonia Trail", "Bear Lake", "Bruneau Dunes", "Castle Rocks", "City of Rocks", "Coeur d’Alene Parkway", "Coeur d’Alene’s Old Mission", "Dworshak", "Eagle Island", "Farragut", "Harriman", "Hells Gate", "Henrys Lake", "Heyburn", "Lake Wolcott", "Land of the Yankee Fork", "Lucky Peak", "Massacre Rocks", "McCroskey", "Ponderosa", "Priest Lake", "Round Lake", "Thousand Springs", "Three Island Crossing", "Trail of the Coeur d’Alenes", "Winchester Lake", "Yellowstone", "Craters of the Moon", "Oregon Trail", "California Trail", "Lewis & Clark Trail", "Nez Perce", "Ice Age Floods", "Hagerman Fossil Beds", "Minidoka"

    creatorId: { type: Schema.ObjectId, required: true, ref: 'Account' },
    section: { type: String, required: true, enum: ["general chat", "equipment", "park", "find group"], default: "general chat" },
